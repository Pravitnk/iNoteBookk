    ...
    return (
        <div className='container'>
            ...
            <div className="form">
                ...
                <div className="mb-3 row">
                    <label htmlFor="tag" className="col-sm-2 col-form-label"><strong>Tag</strong></label>
                    <input type="text" className="form-control" id="tag" name='tag' value={note.tag} onChange={onChange} />
                </div>
                <button disabled={note.title.length<5 || note.description.length<10} type='submit' className='btn btn-primary w-100' onClick={handleclick}>Add Note</button>
            </div>
        </div>
    )
}
